folder <- "C3010"
experimento <- "APO3010-202107-100271"
user <- "vickydiliscia"

base_path <- file.path("/home", user, "dmeyf2025", "src", "churn", folder, "config")

# Lista de módulos a cargar
modules <- c("paths-202107_100271.R", "dataquality.R", "lgbm.R", "experiment.R", 
             "trainingstrategy-202107_100271.R", "features.R", 
             "FE_rf.R", "FE_intrames.R" ,"FE_hist.R",
             "trainfinal-202107_100271.R", "trainentrega.R"
            )
