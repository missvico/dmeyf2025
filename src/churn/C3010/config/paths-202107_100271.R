...
# Paths Base
paths$experimento <- "APO3010-202107-100271"
paths$scriptfolder <- "C3010"
...
paths$datasetcrudo2   <- paste0(paths$datasets , "/competencia_02_crudo.csv.gz")
paths$datasetcrudo3    <- paste0(paths$datasets , "/competencia_03_crudo.csv.gz")
paths$datasetclases <- paste0(paths$datasets , "/competencia_03.csv.gz")
